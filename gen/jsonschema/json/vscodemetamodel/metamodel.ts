 ...
 */
export type MapKeyType = { kind: TypeKind.base; name: BaseTypes.URI | BaseTypes.DocumentUri | BaseTypes.string | BaseTypes.integer } | ReferenceType;
...
export type EnumerationType = { kind: TypeKind.base; name: BaseTypes.string | BaseTypes.integer | BaseTypes.uinteger };
