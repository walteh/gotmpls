...
// ValidateType provides a mock function with given fields: ctx, typePath, pkgInfo
func (_m *MockValidator_types) ValidateType(ctx context.Context, typePath string, pkgInfo *ast.PackageInfo) error {
	ret := _m.Called(ctx, typePath, pkgInfo)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *ast.PackageInfo) error); ok {
		r0 = rf(ctx, typePath, pkgInfo)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockValidator_types_Expecter) ValidateType(ctx interface{}, typePath interface{}, pkgInfo interface{}) *MockValidator_types_ValidateType_Call {
	return &MockValidator_types_ValidateType_Call{Call: _e.mock.On("ValidateType", ctx, typePath, pkgInfo)}
}

func (_c *MockValidator_types_ValidateType_Call) Run(run func(ctx context.Context, typePath string, pkgInfo *ast.PackageInfo)) *MockValidator_types_ValidateType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*ast.PackageInfo))
	})
	return _c
}
...
func (_c *MockValidator_types_ValidateType_Call) RunAndReturn(run func(context.Context, string, *ast.PackageInfo) error) *MockValidator_types_ValidateType_Call {
	_c.Call.Return(run)
	return _c
}
