...
func (_m *MockTemplateFinder_finder) FindTemplates(ctx context.Context, dir string, extensions []string) ([]string, error) {
...
func (_c *MockTemplateFinder_finder_FindTemplates_Call) Return(_a0 []string, _a1 error) *MockTemplateFinder_finder_FindTemplates_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTemplateFinder_finder_FindTemplates_Call) RunAndReturn(run func(context.Context, string, []string) ([]string, error)) *MockTemplateFinder_finder_FindTemplates_Call {
	_c.Call.Return(run)
	return _c
}
