...
func (_m *MockPackageAnalyzer_ast) AnalyzePackage(ctx context.Context, packageDir string) (*ast.PackageInfo, error) {
	...
	var r0 *ast.PackageInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*ast.PackageInfo, error)); ok {
		return rf(ctx, packageDir)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *ast.PackageInfo); ok {
		r0 = rf(ctx, packageDir)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ast.PackageInfo)
		}
	}
...
func (_c *MockPackageAnalyzer_ast_AnalyzePackage_Call) Return(_a0 *ast.PackageInfo, _a1 error) *MockPackageAnalyzer_ast_AnalyzePackage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPackageAnalyzer_ast_AnalyzePackage_Call) RunAndReturn(run func(context.Context, string) (*ast.PackageInfo, error)) *MockPackageAnalyzer_ast_AnalyzePackage_Call {
	_c.Call.Return(run)
	return _c
}
